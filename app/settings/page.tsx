...
const THEMES = [
  ...
  { id: "charcoal", label: "[charcoal]", bg: "#1C1C1E", bg2: "#242426", amber: "#A0522D", rose: "#C4848A" },
]
    ...
    <section>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <a href="/us-plus" style={{ fontFamily: "IBM Plex Mono, monospace", fontSize: "11px", color: "rgba(160,82,45,0.6)", textDecoration: "none" }}>
            [upgrade →]
          </a>
        </div>
      </div>

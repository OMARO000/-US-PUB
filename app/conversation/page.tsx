...
const ARCHETYPE_GRADIENTS: Record<string, string> = {
  ...
  horizon:   "radial-gradient(ellipse at 60% 40%, rgba(160,82,45,0.2) 0%, transparent 70%)",
  ...
  composite: "radial-gradient(ellipse at 50% 40%, rgba(160,82,45,0.15) 0%, transparent 70%)",
  default:   "radial-gradient(ellipse at 50% 40%, rgba(160,82,45,0.12) 0%, transparent 70%)",
}
